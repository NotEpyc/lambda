...
class _FloatingBottomNavbarState extends State<FloatingBottomNavbar>
  ...
  final List<NavItem> _navItems = [
    ...
    NavItem(icon: Icons.cloud, index: 1),
    NavItem(icon: Icons.store, index: 2),
  ...
  Widget build(BuildContext context) {
    ...
    final navbarWidth = _isExpanded ? responsive.navbarWidth : responsive.navbarCollapsedWidth;
    ...
    return Positioned(
      ...
      child: Center(
        child: AnimatedContainer(
          duration: const Duration(milliseconds: 600), // Match the controller duration for smoothness
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              colors: _isExpanded ? [
                const Color(0xFFfffccc), // Light cream when expanded
                const Color(0xFFfff9b3), // Slightly darker cream gradient
              ] : [
                const Color(0xFFffd404), // Bright yellow when collapsed
                const Color(0xFFe8c404), // Darker yellow variant
              ],
            ),
            ...
            boxShadow: [
              BoxShadow(
                color: _isExpanded 
                    ...
                    : const Color(0xFFffd404).withOpacity(0.3),
                blurRadius: _isExpanded ? 25 : 20, // Dynamic shadow blur
                offset: Offset(0, _isExpanded ? 10 : 8), // Dynamic shadow offset
              ),
            ],
          ),
          child: ClipRRect(
                ...
                Center(
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: Colors.transparent, // Remove background when expanded and collapsed
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                                      ...
                                      child: Opacity(
                                        ...
                                        child: GestureDetector(
                                          ...
                                          child: AnimatedContainer(
                                            ...
                                            padding: responsive.navbarItemPadding,
                                            decoration: BoxDecoration(
                                              color: isSelected ? const Color(0xFFe8c404) : Colors.transparent,
                                              borderRadius: BorderRadius.circular(responsive.navbarItemCircularRadius),
                                            ),
                                            child: Icon(
                                              item.icon,
                          ...
                          Expanded(
                            child: SizedBox(width: menuButtonSize),
                          ),
